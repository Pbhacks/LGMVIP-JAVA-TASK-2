# LGMVIP-JAVA-TASK-2
Task 2 for internship LGM VIP
TIC-TAC-TOE Game by Priyant;
...
DEAR USER,
THIS APP HAS BEEN MADE AS A TIC TAC TOE GAME APPLICATION AND, HAS BEEN TESTED BY ME 
...
ON STARTING APP YOU'LL FIND THE GAME AND GET THE OUTPUT VALUE 'ONCLICK' TO THE OTHER VALUES AS EXPECTED.
